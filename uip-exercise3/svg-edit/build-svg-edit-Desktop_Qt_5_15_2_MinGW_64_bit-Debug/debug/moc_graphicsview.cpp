...
#include <memory>
#include "../../svg-edit/graphicsview.h"
...
QT_MOC_LITERAL(4, 37, 11), // "setResource"
QT_MOC_LITERAL(5, 49, 15), // "const Resource*"
QT_MOC_LITERAL(6, 65, 8), // "resource"
QT_MOC_LITERAL(7, 74, 5), // "reset"
QT_MOC_LITERAL(8, 80, 18), // "reloadFromResource"
QT_MOC_LITERAL(9, 99, 16), // "updateStatusData"
...
void GraphicsView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->setResource((*reinterpret_cast< const Resource*(*)>(_a[1])),(*reinterpret_cast< bool(*)>(_a[2]))); break;
        case 2: _t->setResource((*reinterpret_cast< const Resource*(*)>(_a[1]))); break;
        case 3: _t->reloadFromResource(); break;
        case 4: _t->updateStatusData((*reinterpret_cast< const QPoint(*)>(_a[1]))); break;
        default: ;
        }
